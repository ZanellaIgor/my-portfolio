  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between">
        <Link href="#hero" className="text-xl font-bold tracking-tight hover:text-primary transition-colors">
                  ...
                  {navItems.map((item) => (
                    <Link
                      ...
                      className={cn(
                        ...
                        activeSection === item.href.substring(1) && "bg-muted font-medium text-primary",
                      )}
                    >
                      {item.name}
                    </Link>
              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    activeSection === item.href.substring(1) && "font-medium text-primary",
                  )}
                >
                  {item.name}
                </Link>
